                    ...
                    <div className="mt-6">
                        ...
                        <div className="grid grid-cols-2 gap-3 mt-6">
                            <button
                                id="confettiId"
                                onClick={onSubmit}
                                className="inline-flex items-center rounded-md justify-center border-transparent bg-emerald-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
